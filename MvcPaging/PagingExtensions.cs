...
namespace MvcPaging
{
    public static class PagingExtensions
    {
        ...
        public static string PagerWithScript(this HtmlHelper htmlHelper, int pageSize, int currentPage, int totalItemCount, string formName, string url, string divName)
        {
        ...
        public static string Pager(this HtmlHelper htmlHelper, int pageSize, int currentPage, int totalItemCount, string actionName, RouteValueDictionary valuesDictionary, string formName, string url, string divName)
        {
            if (valuesDictionary == null)
            {
                valuesDictionary = new RouteValueDictionary();
