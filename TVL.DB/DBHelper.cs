...
namespace TVL.DB
{
    public class DBHelper
    {
        ...
        // private Int32 intLastInsertId;
        public Int32 intLastInsertId { get; set; }
        ...
        public int ExecuteNonQuery(ArrayList parameterName, ArrayList parameterValues, ArrayList dbType, ref object outValueofParam, IDbTransaction objIdbTransaction, string CommandName)
        {
            ...
            using (IDbConnection objIdbConnection = DataProvider.GetDBConnection())
            {
                ...
                if (Utility.strDBProvider == "sqlserver")
                {
                    ...
                    //if(objIdbCommand.Parameters.Contains("@RETURN_VALUE")){
                    //    SqlParameter p3 = (SqlParameter)objIdbCommand.Parameters["@RETURN_VALUE"];
                    //    intLastInsertId = (Int32) p3.Value;
                    //}
                }
        ...
        public DataTable ExecuteQueryToDataTable(ArrayList parameterName, ArrayList parameterValues, ArrayList dbType, ref object outValueofParam, IDbTransaction objIdbTransaction, string CommandName, Boolean useErrorParams = true)
        {
            ...
            using (IDbConnection objIdbConnection = DataProvider.GetDBConnection())
            {
                PrepareCommand(objIdbCommand, objIdbConnection, objIdbTransaction, parameterName, parameterValues, dbType, CommandName, useErrorParams);
                ...
                {
                    SqlParameter p2;
                    if (objIdbCommand.Parameters.Contains("@strErrorMsg"))
                    {
                        p2 = (SqlParameter)objIdbCommand.Parameters["@strErrorMsg"];
                        ReturnMessage = (string)p2.Value;
                    }
        ...
        public DataTable ExecuteQueryToDataTableForApprovalProcess(ArrayList parameterName, ArrayList parameterValues, ArrayList dbType, ref object outValueofParam, IDbTransaction objIdbTransaction, string CommandName)
        {
            DataSet ds = new DataSet(CommandName);
            IDbCommand objIdbCommand = DataProvider.GetIDBCommand();
            ...
            using (IDbConnection objIdbConnection = DataProvider.GetDBConnection())
            {
                PrepareCommandForApprovalProcess(objIdbCommand, objIdbConnection, objIdbTransaction, parameterName, parameterValues, dbType, CommandName);
        ...
        private void PrepareCommand(IDbCommand objIdbCommand, IDbConnection objIdbConnection, IDbTransaction objIdbTransaction, ArrayList parameterName, ArrayList parameterValues, ArrayList dbType, string CommandName, Boolean useErrorParams = true)
        {
            ...
            try
            {
                ...
                this.CommandParamterMaker(objIdbCommand, parameterName, parameterValues, dbType, CommandName, useErrorParams);
            }
            catch (Exception ex)
            {
        ...
        private void PrepareCommandForApprovalProcess(IDbCommand objIdbCommand, IDbConnection objIdbConnection, IDbTransaction objIdbTransaction, ArrayList parameterName, ArrayList parameterValues, ArrayList dbType, string CommandName)
        {
            objIdbCommand.Connection = objIdbConnection;
            try
            {
                ...
                this.CommandParamterMakerForApprovalProcess(objIdbCommand, parameterName, parameterValues, dbType, CommandName);
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.Message);
        ...
        /// <param name="spno"></param>
        /// <returns></returns>
        private IDataParameter[] CommandParamterMakerForApprovalProcess(IDbCommand objIdbCommand, ArrayList parameterName, ArrayList parameterValues, ArrayList dbType, string ProcedureName)
        {
        ...
        /// <param name="spno"></param>
        /// <returns></returns>
        private IDataParameter[] CommandParamterMaker(IDbCommand objIdbCommand, ArrayList parameterName, ArrayList parameterValues, ArrayList dbType, string ProcedureName, Boolean useErrorParams = true)
        {
