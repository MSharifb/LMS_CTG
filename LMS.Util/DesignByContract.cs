...
{
    /// <summary>
    /// Design by Contract is central in the systematic approach to object-oriented software construction.
    /// <see cref="http://www.eiffel.com/developers/knowledgebase/design_by_contract.html"/>
    /// 
    ...
    public sealed class Check
    {
        ...
        public static void Require(bool assertion, string message)
        {
            ...
            {
                Debug.Assert(assertion, "Precondition: " + message);
            }
        }
        ...
        public static void Require(bool assertion)
        {
            ...
            {
                Debug.Assert(assertion, "Precondition failed.");
            }
        }
        ...
        public static void Ensure(bool assertion, string message)
        {
            ...
            {
                Debug.Assert(assertion, "Postcondition: " + message);
            }
        }
        ...
        public static void Ensure(bool assertion)
        {
            ...
            {
                Debug.Assert(assertion, "Postcondition failed.");
            }
        }
        ...
        public static void Invariant(bool assertion, string message)
        {
            ...
            {
                Debug.Assert(assertion, "Invariant: " + message);
            }
        }
        ...
        public static void Invariant(bool assertion)
        {
            ...
            {
                Debug.Assert(assertion, "Invariant failed.");
            }
        }
        ...
        public static void Assert(bool assertion, string message)
        {
            ...
            {
                Debug.Assert(assertion, "Assertion: " + message);
            }
        }
        ...
        public static void Assert(bool assertion)
        {
            ...
            {
                Debug.Assert(assertion, "Assertion failed.");
            }
        }
