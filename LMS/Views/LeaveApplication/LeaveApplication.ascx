...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#divStyleLeaveApplication").dialog({ autoOpen: false, modal: true, height: 800, width: 920, resizable: false, title: 'Online Leave Application',
    ...
    function popupStyleDetails(Id) {
        ...
        var url = protocol + '//' + host + '/LMS/LeaveApplication/Details/' + Id;
    ...
    function popupStyleAdd() 
    {
        var host = window.location.host;
        var protocol = window.location.protocol;
        var url = protocol + '//' + host + '/LMS/LeaveApplication/LeaveApplicationAdd';
        $('#styleOpenerLeaveApplication').attr({ src: url });
        $("#divStyleLeaveApplication").dialog('open');
        return false;
    }
    ...
    function searchData() {
        ...
        if (hookup == true) {
            var targetDiv = "#divDataList";
            var url = "/LMS/LeaveApplication/LeaveApplication";
            var form = $("#frmLeaveApplicationList");
            var serializedForm = form.serialize();
...
<h3 class="page-title">Online Leave Application</h3>
    ...
    <table class="contenttext" style="width: 100%;">
        <tr>
            ...
            <td>
                ...
                <%=Html.Hidden("Model.strSearchInitial", Model.strSearchInitial)%>
                <%=Html.Encode(Model.strSearchInitial)%>
            </td>
            <td>
               Applicant Name:
            </td>
        ...
        <tr>
            ...
            <td>
                <%= Html.DropDownList("Model.intSearchLeaveTypeId", Model.OnLineLeaveType, "...All...", new { @class = "selectBoxRegular" })%>
            </td>
            <td>
                Status
            </td>
...
<div id="grid">
        ...
        <table>
            <thead>
                <tr>
                    ...
                    if (LMS.Web.Permission.IsMenuOperationPermited(LMS.Web.Permission.MenuNamesId.OnlineLeaveApplication, LMS.Web.Permission.MenuOperation.Edit))
                    {
                        isEditable = true;%>
                    <th style="width: 3%;">                        
                    </th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 12%;">
                        <%=Html.Encode(obj.ApproveDateTime.ToString(LMS.Util.DateTimeFormat.Date))%>                  
                    </td>
                    <%if (isEditable)
                      { %>
                    <td style="width: 3%;">
    ...
    <div class="pager">
        <%= Html.PagerWithScript(ViewData.Model.LstLeaveApplicationPaging.PageSize, ViewData.Model.LstLeaveApplicationPaging.PageNumber, ViewData.Model.numTotalRows, "frmLeaveApplicationList", "/LMS/LeaveApplication/LeaveApplication", "divDataList")%>
...
<div id="divStyleLeaveApplication" style="border: 0px solid white; margin-right: 0px;
    padding-right: 0px;">
