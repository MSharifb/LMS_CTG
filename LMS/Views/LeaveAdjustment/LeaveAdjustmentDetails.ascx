...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        preventSubmitOnEnter($("#frmLeaveAdjustmentDetails"));
    ...
    function checkDateValidation() {
        ...
        if ($('#LeaveApplication_strApplyFromDate').val() != "" && $('#LeaveApplication_strApplyToDate').val() != "") {
            var pdtAPVFrom = parseDate($('#RefLeaveApplication_strApplyFromDate').val());
            var pdtAPVTo = parseDate($('#RefLeaveApplication_strApplyToDate').val());
    ...
    function CalculateDuration() {
        ...
        if (fnValidateDateTime()) {
            ...
            var url = "/LMS/LeaveAdjustment/CalcutateDuration";
            var form = $("#frmLeaveAdjustmentDetails");
            var serializedForm = form.serialize();
    ...
    function OnlineSubmit() {
        ...
        if (fnValidate() && checkDateValidation() == true) {
            ...
            var confResult = true;
            var url = '/LMS/LeaveAdjustment/GetAuthorityResPersonLeaveStatus';
            var form = $('#frmLeaveAdjustmentDetails');
            var serializedForm = form.serialize();
            ...
            $.post(url, serializedForm, function (result) {
                ...
                if (confResult != false) {
                    ...
                    url = '/LMS/LeaveAdjustment/OnlineAdjustmentSubmit';
                    var targetDiv = '#divLeaveAdjustmentDetails';
    ...
    function GetAuthorityInfo() {
        var url = "/LMS/LeaveAdjustment/GetAuthorityInfo";
        var form = $("#frmLeaveAdjustmentDetails");
        var serializedForm = form.serialize();
        ...
        if ($('#LeaveApplication_strSupervisorID').val() != "") {
            $.post(url, serializedForm, function (result) {
                $('#strAuthorDesignation').val(result[1]);
                $('#strAuthorDepartment').val(result[3]);
            }, "json");
...
<form id="frmLeaveAdjustmentDetails" method="post" action="" style="width: 100%">
                        ...
                        <td colspan="4" class="contenttabletd">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <%=Html.TextAreaFor(m => m.LeaveApplication.strPurpose, new { @class = "textRegular required", @style = "width:200px;", @maxlength = 100, onkeyup = "return ismaxlengthPop(this)" })%>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <%--<%if (Model.Approver.Count > 0)
                                          { %>
                                            <%= Html.DropDownListFor(m => m.LeaveApplication.strSupervisorID, Model.Approver, new { @class = "selectBoxRegular", onchange = "return GetAuthorityInfo();" })%>
                                        <%}
                                          else
                                          { %>
                                            <%= Html.DropDownListFor(m => m.LeaveApplication.strSupervisorID, Model.Approver, "...Select One...", new { @class = "selectBoxRegular required" })%>
                                        <%} %>--%>                                      
                                        <%=Html.TextBoxFor(m => m.LeaveApplication.strSupervisorInitial, new { @class = "textRegularDate", @readonly = "readonly" })%>
                                ...
                                <tr>                             
                                    ...
                                    <td colspan="2">
                                        <%=Html.TextBox("strSupervisorName", "", new { @class = "textRegular", @readonly = "readonly" })%>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                    ...
                                    <td colspan="2">
                                        <%=Html.TextBox("strAuthorDesignation", Model.strAuthorDesignation, new { @class = "textRegular", @readonly = "readonly" })%>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                    ...
                                    <td colspan="2">
                                        <%=Html.TextBox("strAuthorDepartment", Model.strAuthorDepartment, new { @class = "textRegular", @readonly = "readonly" })%>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                    ...
                                    <td colspan="2">
                                        <%=Html.TextAreaFor(m => m.LeaveApplication.strRemarks, new { @class = "textRegular", @style = "width:200px;", @maxlength = 200, onkeyup = "return ismaxlengthPop(this)" })%>
                                    </td>
                                </tr>
                            </table>
                        </td>
