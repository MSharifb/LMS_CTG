                        ...
                        <table  width="100%">
                            <tr>
                                <td  colspan="2" align="center">
                                    ...
                                    <%--<a href="#" class="logoMG"></a>--%>
                                </td>
                            </tr>
                            <tr>
                                <td  colspan="2" align="right">
                                    <div class="Print"> 
                                      <b>  Name Of Unit:   <label id="lblUnit"></label> </b>
                                     </div>
                                    <div class="noPrint"> 
                                       <b> Name Of Unit: <%= Html.TextBoxFor(m => m.ConveyanceObj.UNITNAME, new { @class = "textRegCustomWidth", @Style = "width:300px" })%> </b>
                                     </div>
                                </td>
                            </tr>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="noPrint">
                                        <%= Html.TextBoxFor(m=> m.ConveyanceObj.VOUCHERNUMBER, new { @class = "textRegCustomWidth", @style = "width:100px" })%>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="Print">
                                        <b>
                                            <label id="lblDate"> <% if (Model.ConveyanceObj.APPROVEDDATE != null)
...
<div id="grid" class="MainContainer">
    <div id="grid-data">
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tbody>
                <% foreach (ConveyanceDetails item in Model.LstConveyanceDetails)
                   { %>
...
<div class="FooterDiv">
        ...
        <tr>
            <% for (int i = 0; i < Model.LstConveyanceApproverDetails.Count; i++)
             ...
             <td valign="top">
                ...
                <div>
                    <%= Html.Encode(Model.ConveyanceObj.STREMPNAME)%>
                </div>
                <div>
                    <%= Html.Encode(Model.ConveyanceObj.STRDESIGNATION) %>
                </div>
  ...
  <%--  <div style="width:100%;float:left">
        <div style="width:33%;text-align:center;float:left">
             &nbsp;<div>
                <%= Html.Encode(Model.ConveyanceObj.PERMITTEDBY)%> 
            </div>           
        </div>
        <div  style="width:33%;text-align:center;float:left">
             &nbsp;
        ...
        <div  style="width:33%;text-align:center;float:left">
            ...
            { %>
             <div>
                <%= Html.Label(Model.ConveyanceObj.APPROVEDBY) %>
             </div>   
            <%} %>        
        </div>
    </div>
...
<div  class="divButton">
<%--<% if (Model.ConveyanceObj.ISAPPROVED == false)
   { %>--%>
