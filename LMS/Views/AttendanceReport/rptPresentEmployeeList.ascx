...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#1_lblEarlyIn").css("border", "3px solid red");
    });
    ...
    function calculateInOut(ShiftIn, ShiftOut, FirstIn, FirstOut) {
        alert(ShiftIn);
    }
        ...
        <div id="printable" class="divRow">
            <table class="contenttext" style="width: 100%;">
                ...
                <tr>
                    <td style="text-align: center; font-size: large;">
                        <%=Html.Encode("List of Present Employee")%>
                    </td>
                </tr>
                <tr>
           ...
           <%-- <table class="contenttext" style="width: 100%;">
            ...
            <table class="rptcontenttext" style="width: 100%; border-style: solid; border-collapse: collapse"
                ...
                <thead>
                    <tr>
                        <td class="rptrowheader" style="width: 80px">
                            Att. Date
                        </td>
                        ...
                        <td class="rptrowheader" style="width:70px">
                            Early Out (hh:mm)
                        </td>                        
                        <td class="rptrowheader" style="width:60px">
                            Late Out (hh:mm)
                ...
                <tbody style="overflow-y: auto; overflow-x: auto; max-height: 400px; width: 100%;">
                     <%  int count = 0;
                        foreach (LMSEntity.AttendanceReport obj in Model.LstAttendanceReport)
                       {
                           ...
                           {
                                %> <tr>
                                <td colspan="14" style="text-align:left; font-weight:bold;" class="rptrowdetails">
