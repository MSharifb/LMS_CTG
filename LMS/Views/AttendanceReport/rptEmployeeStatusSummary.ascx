...
<div>
    ...
    <div id="divNewWin">
        <div id="printable" class="divRow">
            <table class="contenttext" style="width: 100%;">
                ...
                <tr>
                    <td style="text-align: center; font-size: large;">
                        <%=Html.Encode("Employee Status Summary")%>
                    </td>
                </tr>
                <tr>
            ...
            <table class="rptcontenttext" style="width: 100%; border-style: solid; border-collapse: collapse"
                ...
                <thead>
                    <tr>                        
                        <td rowspan="2" class="rptrowheader" style="width:100px">
                            Emp. ID
                        </td>
                        <td rowspan="2" class="rptrowheader">
                            Emp. Name
                        </td>
                        <td rowspan="2" class="rptrowheader">
                            Designation
                        </td>                       
                        <td colspan="4" class="rptrowheader">
                            Present
                        </td>
                        <td rowspan="2" class="rptrowheader" style="width:50px">
                            Working Day
                        </td>
                        <td rowspan="2" class="rptrowheader" style="width:50px">
                            Absent
                ...
                <tbody style="overflow-y: auto; overflow-x: auto; max-height: 400px; width: 100%;">
                    <%  int count = 0;
                        foreach (LMSEntity.AttendanceReport obj in Model.LstAttendanceReport)
                       {
                           ...
                           {
                                %> <tr>
                                <td colspan="10" style="text-align:left; font-weight:bold;" class="rptrowdetails">
                    ...
                    <tr>                        
                        ...
                        <td class="rptrowdetails">
                            <%=Html.Encode(obj.intEarlyIN)%>
                        </td>
                        <td class="rptrowdetails">
                            <%=Html.Encode(obj.intLateIN)%>
                        </td>
                        <td class="rptrowdetails">
                            <%=Html.Encode(obj.intEarlyOUT)%>
                        </td>
                        <td class="rptrowdetails">
                            <%=Html.Encode(obj.intLateOUT)%>
                        </td>
                        <td class="rptrowdetails">
                            <%=Html.Encode(obj.intWorkingDays)%>
                        </td>
                        <td class="rptrowdetails">
                            <%=Html.Encode(obj.intAbsent)%>
                        </td>
                        <td class="rptrowdetails">
                            <%=Html.Encode(obj.intLeave)%>
                        </td> 
                        <td class="rptrowdetails">
                            <%=Html.Encode(obj.intOSD)%>
                        </td>                        
                    </tr>
                    <%} %>
                </tbody>
    ...
    * EA=Early Arrival, ED=Early Departure, LA=Late Arrival, LD=Late Departure
   </div>
    </div>
