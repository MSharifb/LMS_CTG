...
<div>
    ...
    <div id="divNewWin">
            ...
            <table class="contenttext" style="width: 100%;">
                ...
                <tr>
                    <td style="text-align: center; font-size: large;">
                        <%=Html.Encode("Out of Office Compare")%>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center; text-decoration: underline;">
                        <%=Html.Encode(Model.StrFromDate.ToString())%>
                        &nbsp;To&nbsp;
                        <%=Html.Encode(Model.StrToDate.ToString())%>
                    </td>
                </tr>
            </table>
            <div class="divSpacer">
            ...
            <table class="rptcontenttext" style="width: 100%; border-style: solid; border-collapse: collapse"
                ...
                <thead>
                    <tr>
                        ...
                        <td colspan="2" class="rptrowheader">
                            Out of Office
                        </td>
                    </tr>
                    <tr>                                         
     ...
     <div class="pager">
         <label>Total Records:<%=Model.numTotalRows.ToString() %></label>&nbsp;&nbsp;
   ...
   <div style="text-align:center">
    <a href="#" class="btnPrint" id="btnPrint"></a><a href="#" class="btnPrintPreview"
        id="btnPrintPreview"></a><%--<a href="#" class="btnClose" onclick="return closeDialog();">
        </a>--%></div>
    <%}
       else
       {%>
