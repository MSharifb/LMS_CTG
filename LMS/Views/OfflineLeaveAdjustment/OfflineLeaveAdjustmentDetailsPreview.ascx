...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        preventSubmitOnEnter($("#frmOfflineLeaveAdjustmentPreview"));

        setTitle("Offline Adjustment Appication");
    ...
    function OnlineCancel() {
        ...
        if (result == true) {
            ...
            var url = "/LMS/OfflineLeaveAdjustment/OfflineAdjustmentCancel";
            var form = $("#frmOfflineLeaveAdjustmentPreview");
...
<form id="frmOfflineLeaveAdjustmentPreview" method="post" action="" style="width: 100%">
...
<div class="divButton">
    ...
    <%if (Model.LeaveApplication.intAppStatusID != 1 && Model.LeaveApplication.intAppStatusID != 2 && Model.LeaveApplication.intAppStatusID != 3)
      { %>
        <%if (Model.LeaveApplication.intApplicationID > 0)
          { %>
            <%if (LMS.Web.Permission.IsMenuOperationPermited(LMS.Web.Permission.MenuNamesId.OfflineLeaveAdjustment, LMS.Web.Permission.MenuOperation.Cancel))
              {%>
