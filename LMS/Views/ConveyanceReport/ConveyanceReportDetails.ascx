...
<div id="divNewWin">
     <div id="printable" class="divRow">
            <table width="100%" class="rptcontenttext" style="width: 100%; border-style: solid; border-collapse: collapse"   border="1px">
                ...
                <tbody>
                    <% if(Model.LstConveaynceReport !=null) %>
                    <% foreach (ConveyanceReport item in Model.LstConveaynceReport)
                       { %>
                        ...
                        <tr>
                            ...
                            <td class="rptrowdetails">
                                <%= Html.Encode(item.CONVEYANCEDATE.ToString("dd-MMM-yyyy")) %>
                            </td>
                            <td class="rptrowdetails">
                    ...
                    <%} %>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                 <% if(Model.LstConveaynceReport !=null) {%>
                                    <% string totalAmount =  Model.LstConveaynceReport.Sum(c => c.TOTALAMOUNT).ToString(); %>                                
...
<div class="pager"> <label>
        ...
        <%= Html.PagerWithScript(LMS.Web.AppConstant.PageSize20, Model.LstConveaynceReportPaging.PageNumber, ViewData.Model.numTotalRows, "formConveyanceReport", "/LMS/ConveyanceReport/ShowReport", "divReportView")%>
</div>
